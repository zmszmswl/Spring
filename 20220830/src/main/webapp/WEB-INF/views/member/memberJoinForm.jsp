...
<title>Register Basic - Pages | Sneat - Bootstrap 5 HTML Admin
	Template - Pro</title>
		...
		<div class="authentication-wrapper authentication-basic container-p-y">
			<div class="authentication-inner">
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1"
                        ...
                        <g id="Brand-Logo"
                          ...
                          <g id="Icon"
							...
							</span> <span class="app-brand-text demo text-body fw-bolder">Member Join</span>
							</a>
						</div>
						<!-- /Logo -->
				...
				<form id="formAuthentication" class="mb-3" action="memberJoin.do" method="POST">
							<div class="mb-3">
								<label  class="form-label">Your ID</label> <input
							...
							<div class="mb-3">
								<div class="form-check">
									<input class="form-check-input" type="password"
										id="chkPassword" name="chkPassword" />
								</div>
							</div>
							<button class="btn btn-primary d-grid w-100">Sign up 로그인</button>
				</form>

						<p class="text-center">
							<span>Already have an account?</span> 
							<a href="memberLoginForm.do"> 
								<span>Sign in instead 로그인</span>
							</a>
						</p>
						<p class="text-center">
